!function (e, t) {
    ...
    w.event = {
        global: {}, add: function (e, t, n, r, i) {
            ...
            if (V(e)) for (n.handler && (n = (o = n).handler, i = o.selector), i && w.find.matchesSelector(re, i), n.guid || (n.guid = w.guid++), (u = v.events) || (u = v.events = Object.create(null)), (a = v.handle) || (a = v.handle = function (t) {
                ...
                namespace: h.join(".")
            }, o), (p = u[d]) || ((p = u[d] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(e, r, h, a) || e.addEventListener && ("scroll" == d ? e.addEventListener(d, a, {passive: !0}) : e.addEventListener(d, a))), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), i ? p.splice(p.delegateCount++, 0, c) : p.push(c), w.event.global[d] = !0)
    ...
    function Me(e, t, n, r) {
        ...
        if (p && (a = (i = be(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = a), a || r)) {
            ...
            if (u) for (c = s[s.length - 1].ownerDocument, w.map(s, Oe), f = 0; f < u; f++) l = s[f], ge.test(l.type || "") && !Y.access(l, "globalEval") && w.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? w._evalUrl && !l.noModule && w._evalUrl(l.src, {nonce: l.nonce || l.getAttribute("nonce")}, c) : m(l.textContent.replace(qe, ""), l, c))
        }
        return e
    }
    ...
    var We = new RegExp("^(" + ee + ")(?!px)[a-z%]+$", "i"), Fe = function (t) {
    ...
    var Ue = ["Webkit", "Moz", "ms"], Xe = v.createElement("div").style, Ve = {};
    ...
    function tt(e, t, n) {
        var r = Fe(e), i = (!d.boxSizingReliable() || n) && "border-box" === w.css(e, "boxSizing", !1, r), o = i,
    ...
    w.extend({
        ...
        w.cssHooks[t] = {
            get: function (e, n, r) {
                ...
                var i, o = Fe(e), a = !d.scrollboxSize() && "absolute" === o.position,
        ...
        if (t) return (parseFloat(_e(e, "marginLeft")) || e.getBoundingClientRect().left - Be(e, {marginLeft: 0}, (function () {
