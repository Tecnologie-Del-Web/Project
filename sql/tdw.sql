...
(
    ...
    FOREIGN KEY (user_id) REFERENCES `user` (user_id) ON DELETE NO ACTION ON UPDATE CASCADE,
    FOREIGN KEY (payment_code) REFERENCES payment_method (payment_id) ON DELETE NO ACTION ON UPDATE CASCADE
);
...
(
    ...
    FOREIGN KEY (brand_code) REFERENCES brand (brand_id) ON DELETE NO ACTION ON UPDATE CASCADE
);
...
(
    ...
    FOREIGN KEY (order_id) REFERENCES `order` (order_id) ON DELETE NO ACTION ON UPDATE CASCADE,
...
(
    ...
    FOREIGN KEY (product_id) REFERENCES product (product_id) ON DELETE NO ACTION ON UPDATE CASCADE,
    FOREIGN KEY (discount_id) REFERENCES discount (discount_id) ON DELETE NO ACTION ON UPDATE CASCADE
);