...
(
    ...
    coupon_id       INTEGER UNSIGNED DEFAULT NULL,
...
(
    ...
    brand_description VARCHAR(25) UNIQUE NOT NULL
...
(
    ...
    CHECK (percentage BETWEEN 10.00 AND 100.00),
    UNIQUE (percentage, start_date, expiration_date)
);
