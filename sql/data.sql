...
INSERT INTO product (product_name, price, quantity_available, product_description, sku, brand_id, category_id) VALUES ("Levi's 501 Original Jeans Uomo", 65.00, 100, 'I jeans più famosi al mondo', '501-001', 3, 6);
...
-- Della musica (buona)
INSERT INTO product (product_name, price, quantity_available, product_description, sku, brand_id, category_id) VALUES ("Homogenic - Björk", 18.65, 300, "Il terzo (quarto) album in studio di Björk", 'HOM-001', 6, 3);
INSERT INTO product (product_name, price, quantity_available, product_description, sku, brand_id, category_id) VALUES ("Post - Björk", 21.59, 300, "Il secondo album in studio di Björk", 'POS-001', 6, 3);
